...
@section('content')
    ...
    <div id="events-container" class="mt-3">
        ...
        <div class="mapouter col">
            ...
            <iframe width="1000" height="600" id="gmap_canvas" src="https://maps.google.com/maps?q=Funchal,%20monte%20igreja&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe>
